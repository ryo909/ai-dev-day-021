import './style.css';
const PROFILE = {"day":"Day021","title":"Stakeholder Matrix Mapper","one_sentence":"関係者調整を4象限で整理するステークホルダーマトリクス。（話題:GitHub Trending (A）","core_action":"organize","family":"stakeholder_mapping","mechanic":"axis_mapping","input_style":"item_with_scores","output_style":"quadrant_matrix","audience_promise":"clearer_communication_plan","publish_hook":"誰にいつ話すかを4象限で可視化","engine":"matrix_mapper","interaction_archetype":"matrix_mapper","page_archetype":"matrix_canvas","output_shape":"quadrant_board","state_model":"cells_with_draggable_items","core_loop":"add person -> position -> plan cadence","component_pack":"matrix_grid+cadence_panel","scaffold_id":"matrix_mapper","single_shot_text_generator":false};
